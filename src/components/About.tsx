...
const Sobre = () => {
  return (
    <section className="max-w-7xl mx-auto px-6 py-16 bg-gray-50 text-gray-800 mt-[100px] mb-[100px]">
      <div className="flex flex-col md:flex-row items-center md:items-start gap-12">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-lg leading-relaxed mb-4">
            Na <span className="font-semibold text-blue-600">S4MD</span>, transformamos ideias em soluções digitais inovadoras. Somos uma equipe apaixonada por tecnologia e design, dedicada a criar websites e aplicações que aliam performance, usabilidade e estética. asdfasdfasfd
          </p>
          <p className="text-lg leading-relaxed mb-4">
